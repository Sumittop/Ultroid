...
`git clone https://github.com/Sumittop/Ultroid.git`
...
- Fill your details in a `.env` file, as given in [`.env.sample`](https://github.com/Sumittop/Ultroid/blob/main/.env.sample).
